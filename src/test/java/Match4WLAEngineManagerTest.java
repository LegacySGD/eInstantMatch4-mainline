...
public class Match4WLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Match4WLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Match4IW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Match4IW/InitOutcome.xml").getDocumentElement();
